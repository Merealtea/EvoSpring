...
# Multi-stage simulation and rendering script for EvoSpring (white background)
# This script runs multi-stage rendering with white background and converts results to videos

output_dir="./gaussian_output_dynamic_learnable_white"
...
scenes=("single_lift_cloth_3")
# Experiment name (Gaussian model checkpoint)
exp_name='init=hybrid_iso=True_ldepth=0.001_lnormal=0.0_laniso_0.0_lseg=1.0'
method='End2End_Reduction_Learnable'
...
for scene_name in "${scenes[@]}"; do
    ...
    # Run multi-stage rendering with white background
