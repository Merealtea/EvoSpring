...
class EvoSpring(ModelGeneral):
    def __init__(self, pos_dim, ld, layer_num, pre_layer_num, bottom_layer_num, mlp_hidden_layer, MP_times, enhance, agg_conv_pos, default_spring_Y):
        ...
        # out: d_x
        in_dim = 6 # init_pos, node_mass, node_damping, node_type
        out_dim = pos_dim
    ...
    def _EMD(self, node_feature, edge_mech_in, m_ids, multi_gs, m_gs_parent, pos):
    ...
    def forward(self, m_idx, m_gs, m_gs_parent, node_in, edge_mech_in):
        ...
        _, edge_feature = self._EMD(node_in, edge_mech_in, m_idx, m_gs, m_gs_parent, node_pos)
        ...
        s_out = self.S_0 + edge_mech_in_bias * 50
